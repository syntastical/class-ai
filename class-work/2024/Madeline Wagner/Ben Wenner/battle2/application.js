class Character {
    ...
    attack(character) {
        ...
        if(character.currentHitpoints === 0) {
            addText(`${character.name} Got Cancelled!`);
        }
        this.exhausted = true;
    }
...
let gameState = {
    enemies: [
        new Warrior("X", 200, 0, "enemy", "images/x.png"),
        new Warrior("Meta", 170, 0, "enemy", "images/Meta.png"),
        new Cleric("Sidekick Mark", 100, 50, "enemy", "images/Mark2.jpg"),
        new Mage("Elon Musk", 90, 50, "enemy", "images/Elon Musk.jpg")
    ],
    allies: [
        new Warrior("Garfield", 200, 0, "ally", "images/Garfield2.jpg"),
        new Warrior("Stonks Man", 170, 0, "ally", "images/Stonk.jpg"),
        new Cleric("Doctor Las", 100, 50, "ally", "images/Doctor Las.jpg"),
        new Mage("Toad and Yoshi", 90, 50, "ally", "images/Yoshi.jpg")
    ]
}
...
while(true) {
    ...
    if(aliveEnemies.length === 0) {
        addText('X is no more, Twitter prevailed!')
        break;
    }
