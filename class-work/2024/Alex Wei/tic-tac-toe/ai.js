...
function makeMove(state) {
    ...
    if((state[1][0] ==='X' && state[2][0] ==='X') || (state[1][1] ==='X' && state [2][2] === 'X') || (state[0][1] === 'X' && state [0][2] === 'X') && state [0][0] === '') {
        return [0,0]
    }

    if((state[1][2] ==='X' && state[2][2] ==='X') || (state[1][1] ==='X' && state [0][2] === 'X') || (state[0][0] === 'X' && state [0][1] === 'X') && state [0][2] === '') {
        return [0,0]
    }
    ...
    if(state[1][1] ==='X' && state [0][0] ==='O' && state [0][1] ==='X' && state [2][1] === '') {
        return [2,1]
    }
